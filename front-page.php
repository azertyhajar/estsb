<!DOCTYPE html>
<html <?php language_attributes(); //Affichez le contenu du message.?>>
  <head>
    ...
    <title>
      <?php bloginfo('name'); ?> |
      <?php is_front_page() ? bloginfo('description') : wp_title(); //affiche le titre de la page pour tout du blog?>
    </title>
    <!-- Bootstrap core CSS -->
    ...
    <style>
      .showcase{
        background:url(<?php echo get_theme_mod('showcase_image', get_bloginfo('template_url').'/img/showcase.jpg');//Récupère la valeur de modification du thème pour le thème actuel. ?>) no-repeat center center;
      }
    </style>
  </head>
  <body>
